...
var wallet1 = new Wallet(myKey1,myWalletAddress1,100);
...
class Blockchain {
    ...
    getTotalBalanceOBlockChain(){
        let totalSum = 0
        totalSum += this.getBalanceOfAddress(wallets[1].pk)
        totalSum += this.getBalanceOfAddress(wallets[2].pk)
    ...
    getInitAmout(address)
    {
        return wallets[address].amount;
    }
    isChainValidate() {
